...
import com.telematics.features.reward.databinding.FragmentRewardFeatureHostBinding
...
class RewardFeatureHost : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rewardNavHost.getFragment<NavHostFragment>()
            .navController
                ...
                binding.root.post {
                    try {
                        setFragmentResult(
                            ...
                            bundleOf(INT_RESULT_KEY to if (destination.id == R.id.rewardFragment) 1 else 0)
                        )
                        /*setFragmentResult(
