...
import com.telematics.features.reward.databinding.FragmentDrivecoinsBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class DrivecoinsFragment : BaseFragment() {

    private val driveCoinsViewModel: DriveCoinsViewModel by viewModels()
    ...
    private fun showChart(driveCoinsDetailedData: List<Pair<Int, Int>>, dailyLimitData: Int) {
    ...
    private fun showDailyLimit(dailyLimit: Int) {
    ...
    private fun showDetailedCoins(data: DriveCoinsDetailedData) {
