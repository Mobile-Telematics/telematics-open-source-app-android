...
import com.telematics.core.network.mappers.setCompleteData
import com.telematics.core.network.mappers.toDailyLimitData
import com.telematics.core.network.mappers.toDriveCoinsTotalData
import com.telematics.core.network.mappers.toStreakData
import com.telematics.core.network.mappers.toStreakList
...
class RewardRepositoryImpl @Inject constructor(
    ...
    override suspend fun getStreaks(): List<Streak> {
        ...
        return data.toStreakList(settingsRepository.getDateMeasure())
    }

    override suspend fun getDrivingStreaks(): Result<StreaksData> =
...
interface RewardRepository {
    ...
    suspend fun getDrivingStreaks(): Result<StreaksData>
}