package com.telematics.core.network.mappers

import com.telematics.core.model.RegistrationApiData
...
import com.telematics.core.model.leaderboard.LeaderboardUser
...
import com.telematics.core.model.reward.StreakCarType
import com.telematics.core.model.reward.StreaksData
...
import com.telematics.core.model.statistics.ScoreTypeModel
...
import com.telematics.core.network.model.carservice.CarRest
...
import com.telematics.core.network.model.reward.DailyLimit
import com.telematics.core.network.model.reward.DriveCoinsDetailed
...
import com.telematics.core.network.model.reward.DriveCoinsTotal
...
fun DriveCoinsRest.toDriveCoins() = DriveCoins(
    totalCoins
)
...
fun List<DrivingDetailsData>.toScoreTypeModelList(): List<ScoreTypeModel> {
    ...
    val data = this
    if (data.isEmpty()) return ScoreTypeModel.empty()
    ...
    val res = mutableListOf(
        ...
        ScoreTypeModel(
            ScoreType.ACCELERATION,
            data.last().scoreAcceleration,
            mutableListOf()
        ),
        ScoreTypeModel(
            ScoreType.BREAKING,
            data.last().scoreDeceleration,
            mutableListOf()
        ),
        ScoreTypeModel(
            ScoreType.PHONE_USAGE,
            data.last().scoreDistraction,
            mutableListOf()
        ),
        ScoreTypeModel(
            ScoreType.SPEEDING,
            data.last().scoreSpeeding,
            mutableListOf()
        ),
        ScoreTypeModel(
            ScoreType.CORNERING,
...
fun LeaderboardResponse.toLeaderboardData(type: Int): List<LeaderboardMemberData> {
    ...
    val listFriendsMembersData =
        ArrayList<LeaderboardMemberData>(
            listLeaderboardMemberRest.size
        )
...
fun LeaderboardUser.toListOfLeaderboardUserItems(): List<LeaderboardUserItems> {
    ...
    return mutableListOf(
        ...
        LeaderboardUserItems(
            com.telematics.core.model.leaderboard.LeaderboardType.Acceleration,
            data.usersNumber - data.accelerationPlace.toDouble() + 1,
            data.accelerationPlace,
            data.usersNumber
        ),
        LeaderboardUserItems(
            com.telematics.core.model.leaderboard.LeaderboardType.Deceleration,
            data.usersNumber - data.decelerationPlace.toDouble() + 1,
            data.decelerationPlace,
            data.usersNumber
        ),
        LeaderboardUserItems(
            com.telematics.core.model.leaderboard.LeaderboardType.Speeding,
            data.usersNumber - data.speedingPlace.toDouble() + 1,
            data.speedingPlace,
            data.usersNumber
        ),
        LeaderboardUserItems(
            com.telematics.core.model.leaderboard.LeaderboardType.Distraction,
            data.usersNumber - data.distractionPlace.toDouble() + 1,
            data.distractionPlace,
            data.usersNumber
        ),
        LeaderboardUserItems(
            com.telematics.core.model.leaderboard.LeaderboardType.Turn,
        ...
        LeaderboardUserItems(),
        LeaderboardUserItems(
            com.telematics.core.model.leaderboard.LeaderboardType.Trips,
            data.usersNumber - data.tripsPlace.toDouble() + 1,
            data.tripsPlace,
            data.usersNumber
        ),
        LeaderboardUserItems(
            com.telematics.core.model.leaderboard.LeaderboardType.Distance,
            data.usersNumber - data.distancePlace.toDouble() + 1,
            data.distancePlace,
            data.usersNumber
        ),
        LeaderboardUserItems(
            com.telematics.core.model.leaderboard.LeaderboardType.Duration,
...
fun com.telematicssdk.tracking.services.main.elm.ElmDevice.toElmDevice(): ElmDevice {
    return ElmDevice(
        this.connectedState,
        this.device,
...
fun CheckUserByEmailResponse?.toUserTypeByEmail(): UserTypeByEmail =
    this?.code?.let {
        when (it) {
            0 -> UserTypeByEmail.NEW_USER
            1 -> UserTypeByEmail.REGULAR_USER
            2 -> UserTypeByEmail.NO_USER
            else -> UserTypeByEmail.UNDEFINED
        }
    } ?: UserTypeByEmail.UNDEFINED