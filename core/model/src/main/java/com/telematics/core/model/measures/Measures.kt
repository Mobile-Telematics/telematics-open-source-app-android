package com.telematics.core.model.measures
...
const val MAP_DARK = "dark"
const val MAP_LIGHT = "light"

enum class MapStyle(val value: String) {
    DARK(MAP_DARK),
    LIGHT(MAP_LIGHT);

    companion object {
        fun parse(value: String?): MapStyle {
            return when (value) {
                MAP_LIGHT -> LIGHT
                else -> DARK
            }
